document.addEventListener("DOMContentLoaded", () => {
  // image_view_box 의 img tag 를 한번에 select 하기
  // const image_view = document.querySelector("div.img_view img")

  // image_view_box 를 한번 select 하고
  // image_view_box 가 포함하는 umg tag 를 또한번 select 하기
